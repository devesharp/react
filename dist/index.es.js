        ...
        return (createElement(ClickOutside, { onClickOutside: this.closeUserMenuInfo },
            createElement("div", { className: "container-user", onClick: this.toggleUserMenuInfo, onBlur: this.closeUserMenuInfo },
                createElement("div", { className: "username-container" },
                    ...
                    createElement("div", { className: "username-container-popup " + (!openUserMenuInfo || "opened") },
                        ...
                        createElement("div", { className: "ds-menu" }, !!menuUserBar &&
                            menuUserBar.map(function (item, i) { return (createElement(NavLink, { key: i, className: "ds-item", to: { pathname: item.route }, exact: true }, item.title)); })))))));
    };
    /**
     * Render
     */
    Header.prototype.render = function () {
        ...
        return (createElement(Fragment, null,
            ...
            createElement("div", { className: "ds-header " + (menuOpen ? "ds-menu-mobile-opened" : "") },
                ...
                createElement("div", { className: "ds-header-bottom" },
                    createElement("div", { className: "width-max" },
                        createElement("div", { className: "ds-menu" }, menu.map(function (item) { return (createElement(Fragment, null,
                            ...
                            !!item.subMenu && (createElement("div", { className: "ds-menu-category " + (!item.opened || "hover") },
                                createElement(NavLink, { className: "ds-menu-item " + (!item.opened || "hover"), activeClassName: "ds-menu-item-active", to: { pathname: item.route }, onClick: function (e) { return e.preventDefault(); }, isActive: function (match, location) {
                                        return _this.isSubRoute(location, item.subMenu);
                                    } },
                                    item.title,
                                    " ",
                                    createElement(FontAwesomeIcon, { icon: faChevronDown, flip: "horizontal" })),
                                createElement("div", { className: "ds-menu-subcategory" }, item.subMenu.map(function (subitem, i) { return (createElement(NavLink, { className: "ds-item", activeClassName: "active", to: {
                                        pathname: subitem.route
                                    }, exact: true }, subitem.title)); })))))); })))),
                createElement("div", { className: "ds-menu-mobile" },
                    createElement("div", { className: "ds-table username-info", onClick: this.closeUserMenuInfo },
                    ...
                    menu.map(function (item) { return (createElement(Fragment, null,
                        ...
                        !!item.subMenu && (createElement("div", { className: "ds-menu-category" },
                            createElement(NavLink, { className: "ds-menu-item", activeClassName: "ds-menu-item-active", to: { pathname: item.route }, onClick: function (e) { return e.preventDefault(); }, isActive: function (match, location) { return _this.isSubRoute(location, item.subMenu); } }, item.title),
                            createElement("div", { className: "ds-menu-subcategory" }, item.subMenu.map(function (subitem, i) { return (createElement(NavLink, { className: "ds-item", activeClassName: "active", to: {
                                    pathname: subitem.route
                                }, exact: true }, subitem.title)); })))))); })))));
    };
