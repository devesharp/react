...
function convert(createElement$$1, element) {
  ...
  mixins.attrs['style'] = _objectSpread$1({}, mixins.attrs['style'], existingStyle);
  return createElement$$1.apply(void 0, [element.tag, _objectSpread$1({}, mixins.attrs, remaining)].concat(_toConsumableArray$1(children)));
}
...
function classList(props) {
  ...
  }, _defineProperty$1(_classes, "fa-".concat(props.size), props.size !== null), _defineProperty$1(_classes, "fa-rotate-".concat(props.rotation), props.rotation !== null), _defineProperty$1(_classes, "fa-pull-".concat(props.pull), props.pull !== null), _classes);
...
function normalizeIconArgs(icon$$1) {
  ...
  if (_typeof$1(icon$$1) === 'object' && icon$$1.prefix && icon$$1.iconName) {
    return icon$$1;
  }
...
function FontAwesomeIcon(props) {
  ...
  var renderedIcon = icon(iconLookup, _objectSpread$1({}, classes, transform, mask, {
    symbol: symbol,
    title: title
  }));
...
var InitialsAvatar = /** @class */ (function (_super) {
    ...
    InitialsAvatar.prototype.render = function () {
        this.getLetter();
        return (createElement("div", { className: this.classStyle, style: this.style }, this.initials));
    };
...
var UserAvatar = /** @class */ (function (_super) {
    ...
    UserAvatar.prototype.render = function () {
        ...
        if (image) {
            return (createElement("div", { className: this.classStyle },
                createElement("img", { src: image })));
        }
        else {
            return createElement(InitialsAvatar, { name: name, dark: true, size: size });
        }
    };
    return UserAvatar;
}(Component));
...
var ClickOutside = /** @class */ (function (_super) {
    ...
    ClickOutside.prototype.componentDidMount = function () {
        var _this = this;
        window.addEventListener("click", function (evt) { return _this.handleDocumentClick(evt); });
    };
    ClickOutside.prototype.componentWillUnmount = function () {
        var _this = this;
        window.removeEventListener("click", function (evt) { return _this.handleDocumentClick(evt); });
    };
    ClickOutside.prototype.handleDocumentClick = function (evt) {
        var area = findDOMNode(this.refs.areaRef);
        if (area) {
    ...
    ClickOutside.prototype.render = function () {
        return createElement("div", { ref: "areaRef" }, this.props.children);
    };
    return ClickOutside;
}(Component));
...
var HeaderMobile = function (props) {
    ...
    var user = props.user;
    return (createElement("div", { className: "ds-menu-mobile" },
        createElement("div", { className: "ds-table username-info", onClick: props.closeUserMenuInfo },
            createElement("div", { className: "ds-cell ds-cell-min" },
                createElement(UserAvatar, { user: user, size: "m" })),
            createElement("div", { className: "ds-cell pl-2" },
                createElement("div", { className: "name" }, user.name),
                createElement("div", { className: "role" }, "Editar perfil"))),
        menu.map(function (item) { return (createElement(Fragment, null,
            !item.subMenu && (createElement(NavLink, { className: "ds-menu-item", activeClassName: "ds-menu-item-active", to: { pathname: item.route }, exact: true }, item.title)),
            !!item.subMenu && (createElement("div", { className: "ds-menu-category" },
                createElement(NavLink, { className: "ds-menu-item", activeClassName: "ds-menu-item-active", to: { pathname: item.route }, onClick: function (e) { return e.preventDefault(); }, isActive: function (match, location) {
                        return props.isSubRoute(location, item.subMenu);
                    } }, item.title),
                createElement("div", { className: "ds-menu-subcategory" }, item.subMenu.map(function (subItem, i) { return (createElement(NavLink, { key: subItem.route, className: "ds-item", activeClassName: "active", to: {
...
var Header = /** @class */ (function (_super) {
    ...
    Header.prototype.toggleUserMenuInfo = function () {
        this.setState(function (state, props) { return ({
            openUserMenuInfo: !state.openUserMenuInfo
        }); });
    };
    Header.prototype.toggleUserMenuMobile = function () {
        this.setState(function (state, props) { return ({
     ...
     */
    Header.prototype.closeUserMenuInfo = function () {
    ...
    Header.prototype.renderUserMenu = function () {
        ...
        return (createElement(ClickOutside, { onClickOutside: this.closeUserMenuInfo },
            createElement("div", { className: "container-user", onClick: this.toggleUserMenuInfo, onBlur: this.closeUserMenuInfo },
                createElement("div", { className: "username-container" },
                    createElement("div", { className: "user-image-container" },
                        createElement(UserAvatar, { user: user, size: "s" })),
                    "Ol\u00E1, ",
                    createElement("span", { className: "username" }, user.name),
                    ' ',
                    createElement(FontAwesomeIcon, { icon: faChevronDown, flip: "horizontal" }),
                    createElement("div", { className: "username-container-popup " + (!openUserMenuInfo ||
                            'opened') },
                        createElement("div", { className: "ds-table", onClick: this.closeUserMenuInfo },
                            createElement("div", { className: "ds-cell" },
                                createElement(UserAvatar, { user: user, size: "m" })),
                            createElement("div", { className: "ds-cell pl-2" },
                                createElement("div", { className: "name" }, user.name),
                                createElement("div", { className: "role" }, "Usu\u00E1rio"))),
                        createElement("div", { className: "ds-menu" }, !!menuUserBar &&
                            menuUserBar.map(function (item, i) { return (createElement(NavLink, { key: item.route, className: "ds-item", to: { pathname: item.route }, exact: true }, item.title)); })))))));
    };
    /**
     * Render Menu Desktop
     */
    Header.prototype.renderMenuDesktop = function () {
        ...
        return (createElement("div", { className: "ds-header-bottom" },
            createElement("div", { className: "width-max" },
                createElement("div", { className: "ds-menu" }, menu.map(function (item) { return (createElement(Fragment, null,
                    !item.subMenu && (createElement(NavLink, { className: "ds-menu-item", activeClassName: "ds-menu-item-active", to: { pathname: item.route }, exact: true }, item.title)),
                    !!item.subMenu && (createElement("div", { className: "ds-menu-category " + (!item.opened ||
                            'hover') },
                        createElement(NavLink, { key: item.route, className: "ds-menu-item " + (!item.opened ||
    ...
    Header.prototype.render = function () {
        ...
        return (createElement(Fragment, null,
            createElement("div", { className: "ds-header-mobile-space" }),
            createElement("div", { className: "ds-header " + (menuOpen ? 'ds-menu-mobile-opened' : '') },
                createElement("div", { className: "ds-header-top" },
                    createElement("div", { className: "width-max" },
                        createElement("div", { className: "ds-table w-100 table-header" },
                            createElement("div", { className: "ds-menu-hamburger " + (menuOpen ? 'open' : ''), onClick: this.toggleUserMenuMobile },
                                createElement("span", null),
                                createElement("span", null),
                                createElement("span", null)),
                            createElement("div", { className: "ds-cell vertical-align-middle ds-logo-cell" },
                                createElement("div", { className: "ds-logo" },
                                    createElement("img", { src: logo, alt: "" }))),
                            createElement("div", { className: "ds-cell text-right vertical-align-middle" }, this.props.contentBeforeUser),
                            createElement("div", { className: "ds-cell text-right vertical-align-middle ds-user-cell" }, this.renderUserMenu())))),
                this.renderMenuDesktop(),
                createElement(HeaderMobile, __assign({}, this.props, { closeUserMenuInfo: this.closeUserMenuInfo, isSubRoute: this.isSubRoute })))));
    };
    return Header;
}(Component));
