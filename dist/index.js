...
function convert(createElement, element) {
  ...
  return createElement.apply(void 0, [element.tag, _objectSpread$1({}, mixins.attrs, remaining)].concat(_toConsumableArray$1(children)));
}
...
var ClickOutside = /** @class */ (function (_super) {
    ...
    ClickOutside.prototype.handleDocumentClick = function (evt) {
        var area = ReactDOM.findDOMNode(this.refs.areaRef);
        if (area) {
    ...
    ClickOutside.prototype.render = function () {
        return React.createElement("div", { ref: "areaRef" }, this.props.children);
    };
    return ClickOutside;
}(React.Component));
